...
@section('page_title', 'Viendo Vehículos')
                ...
                <div class="panel panel-bordered">
                    <div class="panel-body" style="padding: 0px">
                        ...
                        <div class="col-md-4 text-right" style="margin-top: 30px">
                            @if (auth()->user()->hasPermission('add_vehicles'))
                            <a href="{{ route('voyager.vehicles.create') }}" class="btn btn-success">
...
@section('javascript')
    ...
    <script>
        ...
        function list(page = 1){
            ...
            let url = '{{ url("admin/vehicles/ajax/list") }}';
